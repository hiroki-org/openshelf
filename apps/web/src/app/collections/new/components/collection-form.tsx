...
export function CollectionForm({ user }: CollectionFormProps) {
  ...
  return (
        ...
        try {
          const res = await apiFetch("/api/collections", {
            ...
            body: JSON.stringify({
              ...
              org_slug:
                ownerType === "org" ? orgSlug.trim().toLowerCase() : undefined,
              name: name.trim(),
    ...
    >
      <div>
        <fieldset>
          <legend className="block text-sm font-medium mb-1">owner_type</legend>
