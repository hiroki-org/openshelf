...
describe("papers routes", () => {
  ...
  it("POST /api/papers deletes uploaded files and paper record on database error", async () => {
    ...
    expect(consoleErrorSpy).toHaveBeenCalledWith(
      ...
      expect.objectContaining({
        ...
        chunkEndExclusive: 1,
        chunkSize: 1,
        chunkSample: expect.arrayContaining([
  ...
  it("PATCH /api/papers/:id accepts valid tags array", async () => {
    const token = await createTestJWT({
      sub: "user-1",
      githubId: "123",
      name: "Uploader",
  ...
  it("PATCH /api/papers/:id accepts empty tags array", async () => {
    const token = await createTestJWT({
      sub: "user-1",
      githubId: "123",
      name: "Uploader",
  ...
  it("PATCH /api/papers/:id rejects non-array tags", async () => {
    const token = await createTestJWT({
      sub: "user-1",
      githubId: "123",
      name: "Uploader",
  ...
  it("PATCH /api/papers/:id rejects non-string items in tags array", async () => {
    const token = await createTestJWT({
      sub: "user-1",
      githubId: "123",
      name: "Uploader",
    ...
    const res = await app.request(
      "http://localhost/api/papers/paper-1",
      {
        ...
        body: JSON.stringify({ tags: ["valid", 123] }),
      },
      env as any,
    );
  ...
  it("PATCH /api/papers/:id rejects too long tag in tags array", async () => {
    const token = await createTestJWT({
      sub: "user-1",
      githubId: "123",
      name: "Uploader",
    ...
    const res = await app.request(
      "http://localhost/api/papers/paper-1",
      {
        ...
        body: JSON.stringify({ tags: ["valid", "a".repeat(100)] }),
      },
      env as any,
    );
