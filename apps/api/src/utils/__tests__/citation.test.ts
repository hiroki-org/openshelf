...
describe("buildCitation", () => {
  ...
  describe("when doi exists", () => {
    const paperWithDoi = { ...paperBase, doi: "10.1145/1234567.8901234" };
    ...
    it("uses doi for bibtex and omits url", () => {
      ...
      expect(bibtex.citation).toContain("doi = {10.1145/1234567.8901234}");
    ...
    it("uses doi url for apa format", () => {
      ...
      expect(apa.citation).toContain("https://doi.org/10.1145/1234567.8901234");
    });
    ...
    it("uses doi prefix for ieee format", () => {
      ...
      expect(ieee.citation).toContain("doi: 10.1145/1234567.8901234");
    });
    ...
    it("uses doi prefix for mla format", () => {
      ...
      expect(mla.citation).toContain("doi:10.1145/1234567.8901234");
    });
  });
